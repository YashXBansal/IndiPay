  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex items-center justify-center">
      <div className="relative w-full max-w-2xl bg-gray-800 p-8 rounded-lg shadow-lg">
        ...
        />
        <div className="pt-20">
          <h2 className="text-3xl font-bold mb-4 text-center">{session.user.name || "John Doe"}</h2>
          <p className="text-gray-400 mb-2 text-center"><strong>Email:</strong> {session.user.email}</p>
          <p className="text-gray-400 text-center"><strong>Phone Number:</strong> {session.user.phone}</p>
        </div>
